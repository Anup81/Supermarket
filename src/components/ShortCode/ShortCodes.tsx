    ...
    <div>
      ...
      <div className="w3_wthree_agileits_icons main-grid-border">
        <div className="container">
          <h2 className="w3_agile_header">Icons</h2>
          <div className="grid_3 grid_4 w3_agileits_icons_page">
            <div className="icons">
              <h3 className="agileits-icons-title">Font Awesome Icons</h3>
              <section id="new">
                <h3 className="page-header page-header icon-subheading">
                  30 New Icons{" "}
                </h3>

                <div className="row fontawesome-icon-list">
                  <div className="icon-box col-md-3 col-sm-4">
                    <a className="agile-icon" href="#">
                      <i
                  ...
                  <div className="icon-box col-md-3 col-sm-4">
                    <a className="agile-icon" href="#">
                      <i className="fa fa-deaf" aria-hidden="true"></i> fa-deaf
                    </a>
                  </div>

                  <div className="icon-box col-md-3 col-sm-4">
                    <a className="agile-icon" href="#">
                      <i className="fa fa-deafness" aria-hidden="true"></i>{" "}
                      deafness <span className="text-muted">(alias)</span>
                    </a>
                  </div>
                  ...
                  <div className="icon-box col-md-3 col-sm-4">
                    <a className="agile-icon" href="#">
                      <i className="fa fa-fa" aria-hidden="true"></i> fa-fa{" "}
                      <span className="text-muted">(alias)</span>
                    </a>
                  </div>
                  ...
                  <div className="icon-box col-md-3 col-sm-4">
                    <a className="agile-icon" href="#">
                      <i className="fa fa-glide" aria-hidden="true"></i>{" "}
                      fa-glide
                    </a>
                  </div>
                  ...
                  <div className="icon-box col-md-3 col-sm-4">
                    <a className="agile-icon" href="#">
                      <i className="fa fa-signing" aria-hidden="true"></i>{" "}
                      fa-signing <span className="text-muted">(alias)</span>
                    </a>
                  </div>
                  ...
                  <div className="icon-box col-md-3 col-sm-4">
                    <a className="agile-icon" href="#">
                      <i className="fa fa-viadeo" aria-hidden="true"></i>{" "}
                      fa-viadeo
                    </a>
                  </div>
              ...
              <div className="section group">
                <div className="box">
                  <div className="title ">
                    <h3 className="page-header icon-subheading">
                  ...
                  <div className="box_content">
                    <div className="fontawesome-icon-list">
                      ...
                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#info-circle">
                          <i className="fa fa-info-circle"></i> fa-info-circle
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#key">
                          <i className="fa fa-key"></i> fa-key
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#keyboard-o">
                          <i className="fa fa-keyboard-o"></i> fa-keyboard-o
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#laptop">
                          <i className="fa fa-laptop"></i> fa-laptop
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#leaf">
                          <i className="fa fa-leaf"></i> fa-leaf
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#gavel">
                      ...
                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#lemon-o">
                          <i className="fa fa-lemon-o"></i> fa-lemon-o
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#level-down">
                          <i className="fa fa-level-down"></i> fa-level-down
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#level-up">
                          <i className="fa fa-level-up"></i> fa-level-up
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#lightbulb-o">
                          <i className="fa fa-lightbulb-o"></i> fa-lightbulb-o
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#location-arrow">
                      ...
                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#lock">
                          <i className="fa fa-lock"></i> fa-lock
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#magic">
                          <i className="fa fa-magic"></i> fa-magic
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#magnet">
                          <i className="fa fa-magnet"></i> fa-magnet
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#share">
                      ...
                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#reply">
                      ...
                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#mail-reply-all">
                      ...
                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#male">
                          <i className="fa fa-male"></i> fa-male
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#map-marker">
                          <i className="fa fa-map-marker"></i> fa-map-marker
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#meh-o">
                          <i className="fa fa-meh-o"></i> fa-meh-o
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#microphone">
                          <i className="fa fa-microphone"></i> fa-microphone
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#microphone-slash">
                      ...
                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#minus">
                          <i className="fa fa-minus"></i> fa-minus
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#minus-circle">
                          <i className="fa fa-minus-circle"></i> fa-minus-circle
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#minus-square">
                          <i className="fa fa-minus-square"></i> fa-minus-square
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#minus-square-o">
                      ...
                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#mobile">
                      ...
                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#money">
                          <i className="fa fa-money"></i> fa-money
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#moon-o">
                          <i className="fa fa-moon-o"></i> fa-moon-o
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#music">
                          <i className="fa fa-music"></i> fa-music
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#pencil">
                          <i className="fa fa-pencil"></i> fa-pencil
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#pencil-square">
                      ...
                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#pencil-square-o">
                      ...
                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#phone">
                          <i className="fa fa-phone"></i> fa-phone
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#phone-square">
                          <i className="fa fa-phone-square"></i> fa-phone-square
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#picture-o">
                          <i className="fa fa-picture-o"></i> fa-picture-o
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#plane">
                          <i className="fa fa-plane"></i> fa-plane
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#plus">
                          <i className="fa fa-plus"></i> fa-plus
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#plus-circle">
                          <i className="fa fa-plus-circle"></i> fa-plus-circle
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#plus-square">
                          <i className="fa fa-plus-square"></i> fa-plus-square
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#plus-square-o">
                      ...
                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#power-off">
                          <i className="fa fa-power-off"></i> fa-power-off
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#print">
                          <i className="fa fa-print"></i> fa-print
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#puzzle-piece">
                          <i className="fa fa-puzzle-piece"></i> fa-puzzle-piece
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#qrcode">
                          <i className="fa fa-qrcode"></i> fa-qrcode
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#question">
                          <i className="fa fa-question"></i> fa-question
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#question-circle">
                      ...
                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#quote-left">
                          <i className="fa fa-quote-left"></i> fa-quote-left
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#quote-right">
                          <i className="fa fa-quote-right"></i> fa-quote-right
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#random">
                          <i className="fa fa-random"></i> fa-random
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#refresh">
                      ...
                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#reply-all">
                          <i className="fa fa-reply-all"></i> fa-reply-all
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#retweet">
                          <i className="fa fa-retweet"></i> fa-retweet
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#road">
                          <i className="fa fa-road"></i> fa-road
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#rocket">
                          <i className="fa fa-rocket"></i> fa-rocket
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#rss">
                          <i className="fa fa-rss"></i> fa-rss
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#rss-square">
                          <i className="fa fa-rss-square"></i> fa-rss-square
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#search">
                          <i className="fa fa-search"></i> fa-search
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#search-minus">
                          <i className="fa fa-search-minus"></i> fa-search-minus
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#search-plus">
                      ...
                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#share-square">
                          <i className="fa fa-share-square"></i> fa-share-square
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#share-square-o">
                      ...
                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#shield">
                          <i className="fa fa-shield"></i> fa-shield
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#shopping-cart">
                      ...
                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#sign-in">
                          <i className="fa fa-sign-in"></i> fa-sign-in
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#sign-out">
                          <i className="fa fa-sign-out"></i> fa-sign-out
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#signal">
                          <i className="fa fa-signal"></i> fa-signal
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#sitemap">
                          <i className="fa fa-sitemap"></i> fa-sitemap
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#smile-o">
                          <i className="fa fa-smile-o"></i> fa-smile-o
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#sort">
                          <i className="fa fa-sort"></i> fa-sort
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#sort-alpha-asc">
                      ...
                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#sort-alpha-desc">
                      ...
                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#sort-amount-asc">
                      ...
                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#sort-amount-desc">
                      ...
                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#sort-asc">
                          <i className="fa fa-sort-asc"></i> fa-sort-asc
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#sort-desc">
                      ...
                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#sort-numeric-asc">
                      ...
                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#sort-numeric-desc">
                      ...
                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#spinner">
                          <i className="fa fa-spinner"></i> fa-spinner
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#square">
                          <i className="fa fa-square"></i> fa-square
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#square-o">
                          <i className="fa fa-square-o"></i> fa-square-o
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#star">
                          <i className="fa fa-star"></i> fa-star
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#star-half">
                          <i className="fa fa-star-half"></i> fa-star-half
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#star-half-o">
                      ...
                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#thumbs-o-up">
                          <i className="fa fa-thumbs-o-up"></i> fa-thumbs-o-up
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#thumbs-up">
                          <i className="fa fa-thumbs-up"></i> fa-thumbs-up
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#ticket">
                          <i className="fa fa-ticket"></i> fa-ticket
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#times">
                          <i className="fa fa-times"></i> fa-times
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#times-circle">
                          <i className="fa fa-times-circle"></i> fa-times-circle
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#times-circle-o">
                      ...
                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#tint">
                          <i className="fa fa-tint"></i> fa-tint
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#caret-square-o-down">
                      ...
                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#caret-square-o-left">
                      ...
                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#caret-square-o-right">
                      ...
                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#caret-square-o-up">
                      ...
                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#trash-o">
                          <i className="fa fa-trash-o"></i> fa-trash-o
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#trophy">
                          <i className="fa fa-trophy"></i> fa-trophy
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#truck">
                          <i className="fa fa-truck"></i> fa-truck
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#umbrella">
                          <i className="fa fa-umbrella"></i> fa-umbrella
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#unlock">
                          <i className="fa fa-unlock"></i> fa-unlock
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#unlock-alt">
                      ...
                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#upload">
                          <i className="fa fa-upload"></i> fa-upload
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#user">
                          <i className="fa fa-user"></i> fa-user
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#users">
                          <i className="fa fa-users"></i> fa-users
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#video-camera">
                          <i className="fa fa-video-camera"></i> fa-video-camera
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#volume-down">
                          <i className="fa fa-volume-down"></i> fa-volume-down
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#volume-off">
                          <i className="fa fa-volume-off"></i> fa-volume-off
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#volume-up">
                          <i className="fa fa-volume-up"></i> fa-volume-up
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#exclamation-triangle">
                      ...
                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#wheelchair">
                          <i className="fa fa-wheelchair"></i> fa-wheelchair
                        </a>
                      </div>

                      <div className="icon-box col-md-3 col-sm-4">
                        <a className="agile-icon" href="#wrench">
                    ...
                    <div className="box_content">
                      <div className="fontawesome-icon-list">
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#check-square">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#check-square-o">
                            <i className="fa fa-check-square-o"></i>{" "}
                            fa-check-square-o
                          </a>
                        </div>
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#circle">
                            <i className="fa fa-circle"></i> fa-circle
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#circle-o">
                            <i className="fa fa-circle-o"></i> fa-circle-o
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#dot-circle-o">
                    ...
                    <div className="box_content">
                      <div className="fontawesome-icon-list">
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#btc">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#jpy">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#usd">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#eur">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#gbp">
                            <i className="fa fa-gbp"></i> fa-gbp
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#inr">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#krw">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#rub">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#try">
                    ...
                    <div className="box_content">
                      <div className="fontawesome-icon-list">
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#align-center">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#align-justify">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#align-left">
                            <i className="fa fa-align-left"></i> fa-align-left
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#align-right">
                            <i className="fa fa-align-right"></i> fa-align-right
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#bold">
                            <i className="fa fa-bold"></i> fa-bold
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#link">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#chain-broken">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#clipboard">
                            <i className="fa fa-clipboard"></i> fa-clipboard
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#columns">
                            <i className="fa fa-columns"></i> fa-columns
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#files-o">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#scissors">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#outdent">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#eraser">
                            <i className="fa fa-eraser"></i> fa-eraser
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#file">
                            <i className="fa fa-file"></i> fa-file
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#file-o">
                            <i className="fa fa-file-o"></i> fa-file-o
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#file-text">
                            <i className="fa fa-file-text"></i> fa-file-text
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#file-text-o">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#floppy-o">
                            <i className="fa fa-floppy-o"></i> fa-floppy-o
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#font">
                            <i className="fa fa-font"></i> fa-font
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#indent">
                            <i className="fa fa-indent"></i> fa-indent
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#italic">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#list">
                            <i className="fa fa-list"></i> fa-list
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#list-alt">
                            <i className="fa fa-list-alt"></i> fa-list-alt
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#list-ol">
                            <i className="fa fa-list-ol"></i> fa-list-ol
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#list-ul">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#paperclip">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#repeat">
                            <i className="fa fa-repeat"></i> fa-repeat
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#undo">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#strikethrough">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#table">
                            <i className="fa fa-table"></i> fa-table
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#text-height">
                            <i className="fa fa-text-height"></i> fa-text-height
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#text-width">
                            <i className="fa fa-text-width"></i> fa-text-width
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#th">
                            <i className="fa fa-th"></i> fa-th
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#th-large">
                            <i className="fa fa-th-large"></i> fa-th-large
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#th-list">
                            <i className="fa fa-th-list"></i> fa-th-list
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#underline">
                    ...
                    <div className="box_content">
                      <div className="fontawesome-icon-list">
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#angle-double-down">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#angle-double-left">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#angle-double-right">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#angle-double-up">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#angle-down">
                            <i className="fa fa-angle-down"></i> fa-angle-down
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#angle-left">
                            <i className="fa fa-angle-left"></i> fa-angle-left
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#angle-right">
                            <i className="fa fa-angle-right"></i> fa-angle-right
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#angle-up">
                            <i className="fa fa-angle-up"></i> fa-angle-up
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#arrow-circle-down">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#arrow-circle-left">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#arrow-circle-o-down">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#arrow-circle-o-left">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#arrow-circle-o-up">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#arrow-circle-right">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#arrow-circle-up">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#arrow-down">
                            <i className="fa fa-arrow-down"></i> fa-arrow-down
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#arrow-left">
                            <i className="fa fa-arrow-left"></i> fa-arrow-left
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#arrow-right">
                            <i className="fa fa-arrow-right"></i> fa-arrow-right
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#arrow-up">
                            <i className="fa fa-arrow-up"></i> fa-arrow-up
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#arrows">
                            <i className="fa fa-arrows"></i> fa-arrows
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#arrows-alt">
                            <i className="fa fa-arrows-alt"></i> fa-arrows-alt
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#arrows-h">
                            <i className="fa fa-arrows-h"></i> fa-arrows-h
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#arrows-v">
                            <i className="fa fa-arrows-v"></i> fa-arrows-v
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#caret-down">
                            <i className="fa fa-caret-down"></i> fa-caret-down
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#caret-left">
                            <i className="fa fa-caret-left"></i> fa-caret-left
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#caret-right">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#caret-up">
                            <i className="fa fa-caret-up"></i> fa-caret-up
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#chevron-circle-down">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#chevron-circle-left">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#chevron-circle-up">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#chevron-down">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#chevron-left">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#chevron-right">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#chevron-up">
                            <i className="fa fa-chevron-up"></i> fa-chevron-up
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#hand-o-down">
                            <i className="fa fa-hand-o-down"></i> fa-hand-o-down
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#hand-o-left">
                            <i className="fa fa-hand-o-left"></i> fa-hand-o-left
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#hand-o-right">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#hand-o-up">
                            <i className="fa fa-hand-o-up"></i> fa-hand-o-up
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#long-arrow-down">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#long-arrow-left">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#long-arrow-right">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#long-arrow-up">
                    ...
                    <div className="box_content">
                      <div className="fontawesome-icon-list">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#backward">
                            <i className="fa fa-backward"></i> fa-backward
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#compress">
                            <i className="fa fa-compress"></i> fa-compress
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#eject">
                            <i className="fa fa-eject"></i> fa-eject
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#expand">
                            <i className="fa fa-expand"></i> fa-expand
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#fast-backward">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#fast-forward">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#forward">
                            <i className="fa fa-forward"></i> fa-forward
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#pause">
                            <i className="fa fa-pause"></i> fa-pause
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#play">
                            <i className="fa fa-play"></i> fa-play
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#play-circle">
                            <i className="fa fa-play-circle"></i> fa-play-circle
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#play-circle-o">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#step-backward">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#step-forward">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#stop">
                            <i className="fa fa-stop"></i> fa-stop
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#youtube-play">
                    ...
                    <div className="box_content">
                      <div className="fontawesome-icon-list">
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#adn">
                            <i className="fa fa-adn"></i> fa-adn
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#android">
                            <i className="fa fa-android"></i> fa-android
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#apple">
                            <i className="fa fa-apple"></i> fa-apple
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#bitbucket">
                            <i className="fa fa-bitbucket"></i> fa-bitbucket
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#bitbucket-square">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#css3">
                            <i className="fa fa-css3"></i> fa-css3
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#dribbble">
                            <i className="fa fa-dribbble"></i> fa-dribbble
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#dropbox">
                            <i className="fa fa-dropbox"></i> fa-dropbox
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#facebook">
                            <i className="fa fa-facebook"></i> fa-facebook
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#facebook-square">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#flickr">
                            <i className="fa fa-flickr"></i> fa-flickr
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#foursquare">
                            <i className="fa fa-foursquare"></i> fa-foursquare
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#github">
                            <i className="fa fa-github"></i> fa-github
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#github-alt">
                            <i className="fa fa-github-alt"></i> fa-github-alt
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#github-square">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#gittip">
                            <i className="fa fa-gittip"></i> fa-gittip
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#google-plus">
                            <i className="fa fa-google-plus"></i> fa-google-plus
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#google-plus-square">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#html5">
                            <i className="fa fa-html5"></i> fa-html5
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#instagram">
                            <i className="fa fa-instagram"></i> fa-instagram
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#linkedin">
                            <i className="fa fa-linkedin"></i> fa-linkedin
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#linkedin-square">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#linux">
                            <i className="fa fa-linux"></i> fa-linux
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#maxcdn">
                            <i className="fa fa-maxcdn"></i> fa-maxcdn
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#pagelines">
                            <i className="fa fa-pagelines"></i> fa-pagelines
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#pinterest">
                            <i className="fa fa-pinterest"></i> fa-pinterest
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#pinterest-square">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#renren">
                            <i className="fa fa-renren"></i> fa-renren
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#skype">
                            <i className="fa fa-skype"></i> fa-skype
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#stack-exchange">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#stack-overflow">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#trello">
                            <i className="fa fa-trello"></i> fa-trello
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#tumblr">
                            <i className="fa fa-tumblr"></i> fa-tumblr
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#tumblr-square">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#twitter">
                            <i className="fa fa-twitter"></i> fa-twitter
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#twitter-square">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#vimeo-square">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#vk">
                            <i className="fa fa-vk"></i> fa-vk
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#weibo">
                            <i className="fa fa-weibo"></i> fa-weibo
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#windows">
                            <i className="fa fa-windows"></i> fa-windows
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#xing">
                            <i className="fa fa-xing"></i> fa-xing
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#xing-square">
                            <i className="fa fa-xing-square"></i> fa-xing-square
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#youtube">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#youtube-square">
                    ...
                    <div className="box_content">
                      <div className="fontawesome-icon-list">
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#ambulance">
                            <i className="fa fa-ambulance"></i> fa-ambulance
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#h-square">
                            <i className="fa fa-h-square"></i> fa-h-square
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#hospital-o">
                            <i className="fa fa-hospital-o"></i> fa-hospital-o
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#medkit">
                        ...
                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#stethoscope">
                            <i className="fa fa-stethoscope"></i> fa-stethoscope
                          </a>
                        </div>

                        <div className="icon-box col-md-3 col-sm-4">
                          <a className="agile-icon" href="#user-md">
          ...
          <div className="grid_3 grid_4">
            <h3 className="w3_agile_header">Bootstrap Glyphicons</h3>
            <h3 className="page-header icon-subheading">Glyphicons</h3>
            <div className="bs-glyphicons">
              ...
              <ul className="bs-glyphicons-list">
                ...
                <li>
                  {" "}
                  <span
                    className="glyphicon glyphicon-eur"
                    aria-hidden="true"
                  ></span>{" "}
                  <span className="glyphicon-className">
                ...
                <li>
                  {" "}
                  <span
                    className="glyphicon glyphicon-volume-down"
                    aria-hidden="true"
                  ></span>{" "}
                  <span className="glyphicon-className">
                ...
                <li>
                  {" "}
                  <span
                    className="glyphicon glyphicon-text-height"
                    aria-hidden="true"
                  ></span>{" "}
                  <span className="glyphicon-className">
                ...
                <li>
                  {" "}
                  <span
                    className="glyphicon glyphicon-indent-left"
                    aria-hidden="true"
                  ></span>{" "}
                  <span className="glyphicon-className">
                ...
                <li>
                  {" "}
                  <span
                    className="glyphicon glyphicon-indent-right"
                    aria-hidden="true"
                  ></span>{" "}
                  <span className="glyphicon-className">
                ...
                <li>
                  {" "}
                  <span
                    className="glyphicon glyphicon-eject"
                    aria-hidden="true"
                  ></span>{" "}
                  <span className="glyphicon-className">
                ...
                <li>
                  {" "}
                  <span
                    className="glyphicon glyphicon-hand-up"
                    aria-hidden="true"
                  ></span>{" "}
                  <span className="glyphicon-className">
                ...
                <li>
                  {" "}
                  <span
                    className="glyphicon glyphicon-hand-down"
                    aria-hidden="true"
                  ></span>{" "}
                  <span className="glyphicon-className">
                ...
                <li>
                  {" "}
                  <span
                    className="glyphicon glyphicon-gbp"
                    aria-hidden="true"
                  ></span>{" "}
                  <span className="glyphicon-className">
                ...
                <li>
                  {" "}
                  <span
                    className="glyphicon glyphicon-compressed"
                    aria-hidden="true"
                  ></span>{" "}
                  <span className="glyphicon-className">
                ...
                <li>
                  {" "}
                  <span
                    className="glyphicon glyphicon-sd-video"
                    aria-hidden="true"
                  ></span>{" "}
                  <span className="glyphicon-className">
                ...
                <li>
                  {" "}
                  <span
                    className="glyphicon glyphicon-hd-video"
                    aria-hidden="true"
                  ></span>{" "}
                  <span className="glyphicon-className">
                ...
                <li>
                  {" "}
                  <span
                    className="glyphicon glyphicon-subtitles"
                    aria-hidden="true"
                  ></span>{" "}
                  <span className="glyphicon-className">
                ...
                <li>
                  {" "}
                  <span
                    className="glyphicon glyphicon-sound-stereo"
                    aria-hidden="true"
                  ></span>{" "}
                  <span className="glyphicon-className">
                ...
                <li>
                  {" "}
                  <span
                    className="glyphicon glyphicon-sound-5-1"
                    aria-hidden="true"
                  ></span>{" "}
                  <span className="glyphicon-className">
                ...
                <li>
                  {" "}
                  <span
                    className="glyphicon glyphicon-sound-6-1"
                    aria-hidden="true"
                  ></span>{" "}
                  <span className="glyphicon-className">
                ...
                <li>
                  {" "}
                  <span
                    className="glyphicon glyphicon-sound-7-1"
                    aria-hidden="true"
                  ></span>{" "}
                  <span className="glyphicon-className">
                ...
                <li>
                  {" "}
                  <span
                    className="glyphicon glyphicon-level-up"
                    aria-hidden="true"
                  ></span>{" "}
                  <span className="glyphicon-className">
                ...
                <li>
                  {" "}
                  <span
                    className="glyphicon glyphicon-king"
                    aria-hidden="true"
                  ></span>{" "}
                  <span className="glyphicon-className">
                ...
                <li>
                  {" "}
                  <span
                    className="glyphicon glyphicon-bishop"
                    aria-hidden="true"
                  ></span>{" "}
                  <span className="glyphicon-className">
                ...
                <li>
                  {" "}
                  <span
                    className="glyphicon glyphicon-baby-formula"
                    aria-hidden="true"
                  ></span>{" "}
                  <span className="glyphicon-className">
                ...
                <li>
                  {" "}
                  <span
                    className="glyphicon glyphicon-lamp"
                    aria-hidden="true"
                  ></span>{" "}
                  <span className="glyphicon-className">
                ...
                <li>
                  {" "}
                  <span
                    className="glyphicon glyphicon-btc"
                    aria-hidden="true"
                  ></span>{" "}
                  <span className="glyphicon-className">
                ...
                <li>
                  {" "}
                  <span
                    className="glyphicon glyphicon-xbt"
                    aria-hidden="true"
                  ></span>{" "}
                  <span className="glyphicon-className">
                ...
                <li>
                  {" "}
                  <span
                    className="glyphicon glyphicon-yen"
                    aria-hidden="true"
                  ></span>{" "}
                  <span className="glyphicon-className">
                ...
                <li>
                  {" "}
                  <span
                    className="glyphicon glyphicon-jpy"
                    aria-hidden="true"
                  ></span>{" "}
                  <span className="glyphicon-className">
                ...
                <li>
                  {" "}
                  <span
                    className="glyphicon glyphicon-ruble"
                    aria-hidden="true"
                  ></span>{" "}
                  <span className="glyphicon-className">
                ...
                <li>
                  {" "}
                  <span
                    className="glyphicon glyphicon-rub"
                    aria-hidden="true"
                  ></span>{" "}
                  <span className="glyphicon-className">
                ...
                <li>
                  {" "}
                  <span
                    className="glyphicon glyphicon-ice-lolly"
                    aria-hidden="true"
                  ></span>{" "}
                  <span className="glyphicon-className">
                ...
                <li>
                  {" "}
                  <span
                    className="glyphicon glyphicon-oil"
                    aria-hidden="true"
                  ></span>{" "}
                  <span className="glyphicon-className">
                ...
                <li>
                  {" "}
                  <span
                    className="glyphicon glyphicon-superscript"
                    aria-hidden="true"
                  ></span>{" "}
                  <span className="glyphicon-className">
                ...
                <li>
                  {" "}
                  <span
                    className="glyphicon glyphicon-subscript"
                    aria-hidden="true"
                  ></span>{" "}
                  <span className="glyphicon-className">
