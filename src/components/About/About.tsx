...
import BreadCrumbs from "../Breadcumb/Breadcumb";
            ...
            <div className="team-agileitsinfo">
              <div className="col-md-3 about-team-grids">
                ...
                <div className="social-icons caption">
                  <ul>
                    <li>
                      <Link to="#" className="fa fa-facebook facebook">
                        {" "}
                      </Link>
                    </li>
                    <li>
                      <Link to="#" className="fa fa-twitter twitter">
                        {" "}
                      </Link>
                    </li>
                    <li>
                      <Link to="#" className="fa fa-google-plus googleplus">
                        {" "}
                      </Link>
                    </li>
                  </ul>
